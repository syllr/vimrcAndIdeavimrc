...
"hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=Black guibg=Yellow gui=underline
"search高亮为蓝色的配置

"hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=#90fff0 guibg=#2050d0 gui=underline
"search高亮为orange的配置

hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=black guibg=orange gui=underline
...
hi Title ctermfg=255 ctermbg=NONE cterm=bold guifg=Magenta guibg=NONE gui=bold
